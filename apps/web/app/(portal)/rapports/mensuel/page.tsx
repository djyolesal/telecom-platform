    ...
    <div>
      ...
      <FormCard>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          <button type="button" onClick={() => downloadFile(pdfPath, `rapport-${annee}-${mois}.pdf`, true)} className="inline-flex items-center gap-2 rounded-lg bg-[rgb(var(--brand))] px-3.5 py-2 text-sm font-medium text-white hover:bg-[rgb(var(--brand-light))]">
