  ...
  return (
    <div className="flex flex-col items-center justify-center gap-2.5 py-16 text-sm text-gray-400">
      <svg width="58" height="58" viewBox="0 0 120 120" aria-hidden="true">
        <path d="M104 60 L82 98 L38 98 L16 60 L38 22 L82 22 Z" fill="none" stroke="rgb(var(--brand))" strokeWidth="9" strokeLinejoin="round" />
        <circle cx="60" cy="64" r="7" fill="#F59E0B" />
        <path className="emops-arc1" d="M46 52 A18 18 0 0 1 74 52" fill="none" stroke="rgb(var(--accent))" strokeWidth="6.5" strokeLinecap="round" />
        <path className="emops-arc2" d="M40 45 A25 25 0 0 1 80 45" fill="none" stroke="rgb(var(--accent))" strokeWidth="6.5" strokeLinecap="round" />
      </svg>
      <svg width="140" height="20" viewBox="0 0 200 24" aria-hidden="true">
        ...
        <circle cx="194" cy="16" r="4" fill="rgb(var(--accent))" />
      </svg>
      {label}
    </div>
  );
