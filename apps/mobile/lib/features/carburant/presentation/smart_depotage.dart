          ...
          children: [
            ...
            if (lignes.isEmpty)
              Padding(
                ...
                child: Text('Aucune livraison planifiée pour ce site.',
                    style: TextStyle(color: Colors.grey.shade600)),
              )
            else ...[
              Text('Touchez une livraison à dépoter (${lignes.length})',
                ...
                child: ListView(
                  ...
                  children: lignes
                      .map((l) => ListTile(
                            ...
                            subtitle: l.restant > 0
                                ? Text(
                                    'Reste à livrer : ${l.restant.toStringAsFixed(0)} L')
                                : const Text('Soldée'),
                            ...
                            onTap: () {
                              ...
                              router.push(
                                  '/carburant/nouveau?siteId=${site.id}&ligneId=${l.id}');
                            },
                          ))
                      .toList(),
                ),
